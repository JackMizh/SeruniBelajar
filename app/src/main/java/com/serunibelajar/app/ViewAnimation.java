...
public class ViewAnimation {
    ...
    public static void fadeIn(final View v) {
        com.serunibelajar.app.ViewAnimation.fadeIn(v, null);
    }
    ...
    public static void fadeOut(final View v) {
        com.serunibelajar.app.ViewAnimation.fadeOut(v, null);
    }
    ...
    public static void showScale(final View v) {
        com.serunibelajar.app.ViewAnimation.showScale(v, null);
    }
